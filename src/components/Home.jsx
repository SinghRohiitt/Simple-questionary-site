...
const Home = () => {
  return (
   ...
   <div className="home2">
      ...
      <div>
        <p>
          We are your one and only solution to the tech priblems you face every day. We are leading tech company whose aim is to increase the problem solving sboility in children.
        </p>
      </div>
   </div>
